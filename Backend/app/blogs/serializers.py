...
class BlogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Blog
        fields= ['id','title','caption','type','status','created','tags','demo_link','github_link','kaggle_link','other_source_link','thumbnail','blog_date','body']
        read_only_fields= ['id']
    ...
    def create(self, validated_data):
        ...
        project= Blog.objects.create(**validated_data)
